...
document.getElementById("stateDisplay").innerHTML =
  "Session<br/>0 pomodoros completed";
...
document.getElementById("timerBlock").addEventListener("click", timerPress);
...
function secondCountDown() {
  document.getElementById("timerDisplay").innerHTML =
    timerMinutes + ":" + setTwoDigits(timerSeconds);
  timerSeconds--;
  if (timerSeconds < 0) {
    timerSeconds = 59;
    timerMinutes--;
...
function setNextPomodoroState() {
  ...
  if (pomodoroState === 0) {
    ...
    if (completedPomodoros % 4 === 0) {
      pomodoroState = 2;
      document.getElementById("stateDisplay").innerHTML =
        "Long break<br/>" + completedPomodoros + " pomodoros completed";
    } else {
      pomodoroState = 1;
      document.getElementById("stateDisplay").innerHTML =
        "Short break<br/>" + completedPomodoros + " pomodoros completed";
    }
  } else {
    if (pomodoroState === 1) {
    ...
    pomodoroState = 0;
    document.getElementById("stateDisplay").innerHTML =
      "Session<br/>" + completedPomodoros + " pomodoros completed";
  }
